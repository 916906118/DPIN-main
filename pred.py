...
def main(args):
    ...
    checkpoint = torch.load('save_model/best_model/DPIN.pth', map_location=torch.device('cuda'))
...
def parse_args():
    ...
    parser.add_argument('--img_dir', type=str, default="./dataset/PLCT_FDG/")
    parser.add_argument('--split_train_val_test', type=str, default='./dataset/PLCT_FDG/')
